...
public class CajaArea {
    ...
    public static Componente crearArea(ArrayList elementos, String texto, Boolean editable, int f, int c) {
    ...
    public static Componente modificarArea(JTextPane area, String nombre, Object valor, int f, int c) {
